(function () {
  ...
  function renderHeader(target) {
    ...
    target.outerHTML = [
      ...
      '    <a class="navbar-brand" href="' + link(root, 'index.html') + '" aria-label="Vietceramics">',
      '      <svg viewBox="0 0 200 46" fill="none" xmlns="http://www.w3.org/2000/svg">',
      '        <rect width="200" height="46" fill="none"></rect>',
      '        <text x="0" y="32" font-family="Averta Std, Avenir Next, sans-serif" font-weight="800" font-size="24" fill="#981B1E" letter-spacing="2" textLength="196" lengthAdjust="spacingAndGlyphs">VIETCERAMICS</text>',
      '      </svg>',
      '    </a>',
  ...
  function renderFooter(target) {
    ...
    target.outerHTML = [
      ...
      '        <div class="brand-svg"><svg viewBox="0 0 200 46" fill="none"><text x="0" y="32" font-family="Averta Std, Avenir Next, sans-serif" font-weight="800" font-size="22" fill="#fff" letter-spacing="2">VIETCERAMICS</text></svg></div>',
      '        <div class="contact-info"><p><a href="tel:0797555299">0797 555 299</a></p><p><a href="mailto:vietceramics@vietceramics.com.vn">vietceramics@vietceramics.com.vn</a></p></div>',
      ...
      '      </div>',
      '      <div class="footer-col"><h5>Vietceramics</h5><ul><li><a href="' + link(root, 've-chung-toi.html') + '">Về Chúng Tôi</a></li><li><a href="#">Thông tin &amp; Báo cáo</a></li><li><a href="' + link(root, 'du-an.html') + '">Dự án</a></li><li><a href="#">Liên hệ Showroom</a></li><li><a href="#">Dịch vụ khách hàng</a></li></ul></div>',
