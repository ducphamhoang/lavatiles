(function () {
  ...
  function renderFooter(target) {
    ...
    target.outerHTML = [
      ...
      '      </div>',
      '      <div class="footer-col"><h5>Lavatiles</h5><ul><li><a href="' + link(root, 've-chung-toi.html') + '">Về Chúng Tôi</a></li><li><a href="' + link(root, 'lien-he.html') + '">Liên hệ</a></li><li><a href="#">Dịch vụ khách hàng</a></li></ul></div>',
