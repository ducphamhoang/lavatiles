(function () {
  ...
  function renderHeader(target) {
    ...
    target.outerHTML = [
      ...
      '    <a class="navbar-brand" href="' + link(root, 'index.html') + '" aria-label="Lavatiles">',
      '      <svg viewBox="0 0 200 46" fill="none" xmlns="http://www.w3.org/2000/svg">',
      '        <rect width="200" height="46" fill="none"></rect>',
      '        <text x="0" y="32" font-family="Averta Std, Avenir Next, sans-serif" font-weight="800" font-size="24" fill="#981B1E" letter-spacing="2" textLength="196" lengthAdjust="spacingAndGlyphs">LAVATILES</text>',
      '      </svg>',
      '    </a>',
      ...
      tileGroupList(root),
       ...
       '              <ul>',
       '                <li><a href="' + link(root, 'san-pham/thiet-bi-ve-sinh/index.html') + '">Xem tất cả TOTO</a></li>',
       '                <li><a href="' + link(root, 'san-pham/thiet-bi-ve-sinh/index.html?category=B%C3%A0n%20c%E1%BA%A7u#pd-filters') + '">Bàn cầu</a></li>',
       '                <li><a href="' + link(root, 'san-pham/thiet-bi-ve-sinh/index.html?category=Ch%E1%BA%ADu%20r%E1%BB%ADa#pd-filters') + '">Chậu rửa</a></li>',
       '                <li><a href="' + link(root, 'san-pham/thiet-bi-ve-sinh/index.html?category=Sen%20t%E1%BA%AFm#pd-filters') + '">Sen tắm</a></li>',
       '                <li><a href="' + link(root, 'san-pham/thiet-bi-ve-sinh/index.html?category=B%E1%BB%93n%20t%E1%BA%AFm#pd-filters') + '">Bồn tắm</a></li>',
       '              </ul>',
       '            </div>',
       '            <div class="megamenu-col">',
      '              <h6>Theo Phòng</h6>',
      ...
      '              <h6>Thương hiệu</h6>',
      '              <ul>',
      '                <li><a href="' + link(root, 'san-pham/gach-op-lat/index.html?brand=eurotile') + '">Eurotile</a></li>',
      '                <li><a href="' + link(root, 'san-pham/gach-op-lat/index.html?brand=vietytile') + '">VietY Tile</a></li>',
      '                <li><a href="' + link(root, 'san-pham/gach-op-lat/index.html?brand=vasta-stone') + '">Vasta Stone</a></li>',
       '                <li><a href="' + link(root, 'san-pham/thiet-bi-ve-sinh/index.html') + '">TOTO</a></li>',
      '                <li><a href="' + link(root, 'catalogue.html') + '">INAX</a></li>',
      ...
      '    <li class="nav-item dropdown"><a class="nav-link" href="' + link(root, 'san-pham/gach-op-lat/index.html') + '">Gạch ốp lát</a><div class="dropdown-menu"><ul>' + tileGroupList(root) + '</ul></div></li>',
       ...
       '    <li class="nav-item"><a class="nav-link" href="' + link(root, 'san-pham/thiet-bi-ve-sinh/index.html') + '">Thiết bị vệ sinh</a></li>',
          
       '    <li class="nav-item dropdown"><a class="nav-link" href="#">Thương hiệu</a><div class="dropdown-menu"><ul><li><a href="' + link(root, 'san-pham/gach-op-lat/index.html?brand=eurotile') + '">Eurotile</a></li><li><a href="' + link(root, 'san-pham/gach-op-lat/index.html?brand=vietytile') + '">VietY Tile</a></li><li><a href="' + link(root, 'san-pham/gach-op-lat/index.html?brand=vasta-stone') + '">Vasta Stone</a></li><li><a href="' + link(root, 'san-pham/thiet-bi-ve-sinh/index.html') + '">TOTO</a></li><li><a href="' + link(root, 'catalogue.html') + '">INAX</a></li><li><a href="#">Viglacera</a></li></ul></div></li>',
      '    <li class="nav-item"><a class="nav-link' + activeClass(active, 'about') + '" href="' + link(root, 've-chung-toi.html') + '">Về chúng tôi</a></li>',
      '    <li class="nav-item"><a class="nav-link' + activeClass(active, 'projects') + '" href="' + link(root, 'du-an.html') + '">Dự án</a></li>',
      '    <li class="nav-item"><a class="nav-link' + activeClass(active, 'catalogue') + '" href="' + link(root, 'catalogue.html') + '">Catalogue</a></li>',
  ...
  function renderFooter(target) {
    ...
    target.outerHTML = [
      ...
      '        <div class="brand-svg"><svg viewBox="0 0 200 46" fill="none"><text x="0" y="32" font-family="Averta Std, Avenir Next, sans-serif" font-weight="800" font-size="22" fill="#fff" letter-spacing="2">LAVATILES</text></svg></div>',
      '        <p style="color: var(--accent); font-size: 0.85rem; margin: 4px 0 12px; letter-spacing: 0.5px; opacity: 0.9;">Tinh Tế Trong Từng Không Gian</p>',
      '        <div class="contact-info"><p><a href="tel:0906071079">0906 071 079</a> - <a href="tel:0989953690">098.995.3690</a></p><p><a href="mailto:lavatiles.ceramic@gmail.com">lavatiles.ceramic@gmail.com</a></p></div>',
      ...
      '        <div class="footer-address"><p style="color: #999; font-size: 0.85rem; line-height: 1.5; margin-top: 10px;"><strong>Trụ Sở Chính:</strong> Số 17/1 Đường ĐT743, Khu Phố Bình Quới B, Phường Thuận Giao, TP. Thuận An, Tỉnh Bình Dương</p><p style="color: #999; font-size: 0.85rem; line-height: 1.5;"><strong>Showroom Vũng Tàu:</strong> Số 680A3, Đường Bình Giã, Phường Rạch Dừa, TP. Vũng Tàu</p></div>',
      '        <p class="footer-showroom-link"><a href="#">Tìm địa chỉ Showroom</a></p>',
      '      </div>',
      '      <div class="footer-col"><h5>Lavatiles</h5><ul><li><a href="' + link(root, 've-chung-toi.html') + '">Về Chúng Tôi</a></li><li><a href="#">Thông tin &amp; Báo cáo</a></li><li><a href="' + link(root, 'du-an.html') + '">Dự án</a></li><li><a href="#">Liên hệ Showroom</a></li><li><a href="#">Dịch vụ khách hàng</a></li></ul></div>',
      '      <div class="footer-col"><h5>Gạch Ốp Lát</h5><ul>' + tileGroupList(root) + '</ul></div>',
       '      <div class="footer-col"><h5>Thiết Bị Vệ Sinh</h5><ul><li><a href="' + link(root, 'san-pham/thiet-bi-ve-sinh/index.html?category=V%C3%B2i%20ch%E1%BA%ADu#pd-filters') + '">Vòi nước</a></li><li><a href="' + link(root, 'san-pham/thiet-bi-ve-sinh/index.html?category=Ch%E1%BA%ADu%20r%E1%BB%ADa#pd-filters') + '">Lavabo — Chậu rửa</a></li><li><a href="' + link(root, 'san-pham/thiet-bi-ve-sinh/index.html?category=B%C3%A0n%20c%E1%BA%A7u#pd-filters') + '">Bồn cầu</a></li><li><a href="' + link(root, 'san-pham/thiet-bi-ve-sinh/index.html?category=B%E1%BB%93n%20t%E1%BA%AFm#pd-filters') + '">Bồn tắm</a></li><li><a href="' + link(root, 'san-pham/thiet-bi-ve-sinh/index.html?category=Sen%20t%E1%BA%AFm#pd-filters') + '">Sen tắm</a></li><li><a href="' + link(root, 'san-pham/thiet-bi-ve-sinh/index.html') + '">Xem tất cả</a></li></ul></div>',
      ...
      '    </div>',
      '    <div class="footer-bottom"><span>@2025 LAVATILES<br>Công Ty Cổ Phần Lavatiles<br>Thành lập năm 2025.</span><div class="cert"><svg width="80" height="40" viewBox="0 0 80 40"><rect fill="#555" width="80" height="40" rx="2"></rect><text x="50%" y="50%" text-anchor="middle" dy=".3em" font-size="8" fill="#999">Bộ Công Thương</text></svg></div></div>',
      '  </div>',
      '</footer>'
    ].join('\n');
  }
